...
# OCR 모델
get_ipython().system('pip install easyocr==1.7.1')
# 이미지 영상 처리
get_ipython().system('pip install opencv-python')
# PyTorch와 torchvision 설치
get_ipython().system('pip install torch==2.2.1')
get_ipython().system('pip install torchvision==0.17.1')
get_ipython().system('pip install torchaudio==2.2.1')
# matplotlib 설치
